...
//#endif
    ...
    IMGUI_API bool          Keybind(const char* label, int* key, int* mode, bool show_label);

    IMGUI_API void          GradientText(const char* label, ImVec2 pos, ImU32 one_color, ImU32 two_color);

    // Widgets
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0);
    IMGUI_API bool          Tab(bool selected, ImTextureID image, const ImVec2& size_arg);
